...
# ╔═╡ affd15dc-f0c1-11eb-37e2-7f6df754d6bd
begin
	using Agents, Random
	using CairoMakie
...
# ╔═╡ 43ed6789-c001-4364-aa0f-aa8b6ddb81f9
md"""
# Elementary celular automata

Here, we implement cellular automata in julia using Agents.jl. 
"""

# ╔═╡ 9d0552b3-9823-469d-9c45-1d13c4bb871b
md"""
We're going to use these packages
"""

# ╔═╡ bbe62cc6-c9c5-42c0-b7c3-69c7c0535cd8
md"""
First, we define the automaton living in a 1D space. We're using the package Agents.jl to create the model
"""

# ╔═╡ c290b55b-dfab-40bd-b07f-56e57dc7811a
"""
...
# ╔═╡ 9891246c-cd91-410e-90ec-e897a05d1a56
md"""
A single rule on an elementary automaton can be ...
# TODO
"""

# ╔═╡ 68b11c3b-7cb9-4bea-8806-f668be9861ec
"""
...
# ╔═╡ 202dda7b-7b1e-4902-a1f5-75e4a8b76761
"""
...
# ╔═╡ a3c6d798-a256-461a-920e-a7672f40c9d5
"""
...
# ╔═╡ 061f8ad5-7643-4c3d-a1b5-f42acb707e1a
"""
Initializes the ABM
...
# ╔═╡ c28393f5-f267-4f18-87e3-3b372b3de83b
"""
...
# ╔═╡ ed4c31ac-59f8-4f51-8759-6dc0f7b63075
"""
...
# ╔═╡ 7be6dfb6-23bc-4a37-afba-f1a69ef85c2b
md"""
## Running the model

Lets setup some initialization variables, namely the number of cells, and the wolfram_code to use.

Wolfram code(0-255): $(@bind wolfram_code PlutoUI.NumberField(0:255, default=30))

N cells(3-1001): $(@bind n_cells PlutoUI.NumberField(3:1001, default=101))

Max steps(10-500): $(@bind max_steps PlutoUI.NumberField(10:500, default=100))

Random start: $(@bind random_start PlutoUI.CheckBox(default=true))
"""

# ╔═╡ eeb17b56-000b-4023-b84c-1dcb735a51f2
md"""
Here we run the automata and collect data
"""

# ╔═╡ 365ee475-4252-49d3-870e-2b7828429c50
begin
	model = build_model(
		n_cells=n_cells, wolfram_code=wolfram_code, random_start=random_start)

	# Runs the model and collects data
	data, _ = run!(model, cell_step!, ca_step!, max_steps; adata=[:status])
end;

# ╔═╡ f456fa04-32c7-4bb2-b62b-3e3f74ba9a27
md"""
Lets plot the time evolution in the y axis
"""

# ╔═╡ 39b73998-5238-4f11-8126-b0e970edcfce
begin
...
# ╔═╡ 60418c85-7e06-4c8b-bc02-6f86d85d9d01
md"""
The plot was possible because the data contains the step, id/position and status of the cell (1/0)
"""

# ╔═╡ 13a7809b-5f19-457d-aa1c-8b7329e1c59f
first(data, 10)
...
git-tree-sha1 = "42dfaaefcd4031a81597b86387470769098d8189"
...
git-tree-sha1 = "8c77c74af4e149611b55b40f0b3085fe2b9d8ccf"
